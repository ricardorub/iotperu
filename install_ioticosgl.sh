...
sudo git clone https://github.com/ricardorub/iotperu.git
sudo mv iotperu services
...
sudo git clone https://github.com/ricardorub/iotperu2.git
sudo mv iotperu2 app
